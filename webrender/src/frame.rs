...
use webrender_traits::{BuiltDisplayList, BuiltDisplayListIter, ClipDisplayItem, ClipId, ClipRegion};
use webrender_traits::{ColorF, DeviceUintRect, DeviceUintSize, Epoch, FilterOp};
...
pub struct Frame {
    ...
    pub display_lists: DisplayListMap,
    id: FrameId,
...
impl Frame {
    ...
    pub fn create(&mut self,
        ...
        self.display_lists = scene.display_lists.clone();   // TODO: don't do this
    ...
    fn flatten_stacking_context<'a>(&mut self,
        ...
        let composition_operations = {
            // TODO: self.traversal.display_list()?
